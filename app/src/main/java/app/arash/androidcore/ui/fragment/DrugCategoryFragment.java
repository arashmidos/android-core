...
public class DrugCategoryFragment extends Fragment {
  ...
  private void setUpRecyclerView() {
    //TODO:need to load drugs category list
    List<String> category = new ArrayList<>();
    category.add("شکیب ساز");
    category.add("زیبایی شکیب");
    category.add("هیکل شکیب");
    category.add("داوانگی شکیب");
    category.add("ضد عشق به شکیب");
    category.add("نفخ پا");
    category.add("انگشت کوچیک درد");
    category.add("شصت تو چشم");
    category.add("بیهوش شکیب");
    category.add("کشش پوست");
    DrugCategoryAdapter drugCategoryAdapter = new DrugCategoryAdapter(mainActivity, category);
